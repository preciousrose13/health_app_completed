...
class _SearchPageState extends State<SearchPage> {
  ...
  Future<ChatRoomModel?> getChatroomModel(UserModel targetUser) async {
    ...
    if(snapshot.docs.length > 0) {
      ...
      await FirebaseFirestore.instance.collection("Chat Rooms").doc(newChatroom.chatroomid).set(newChatroom.toMap());
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              StreamBuilder(
                stream: FirebaseFirestore.instance.collection("Registered Users").where
                ("email", isEqualTo: searchController.text).where
