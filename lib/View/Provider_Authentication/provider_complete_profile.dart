...
class CompleteProfileProvider extends StatefulWidget {
  ...
  const CompleteProfileProvider({super.key, required this.userModel, required this.firebaseUser});


  @override
  State<CompleteProfileProvider> createState() => _CompleteProfileProviderState();
}
    ...
    .doc(widget.userModel.uid).set(widget.userModel.tomap()).then((value) {
      ...
      Navigator.pushReplacement(
        ...
        MaterialPageRoute(builder: (context) {
          return Service_Provider_Home(userModel: widget.userModel, firebaseUser: widget.firebaseUser, userEmail: '',);
        }),
      );
    });
  }
